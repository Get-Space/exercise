...
def get_highest_weight(questions: dict) -> str:
    ...
    question_weights = {question_id: questions[question_id]['weight'] for question_id in questions}
    ...
    return random.choice(highest_weight_questions) if len(highest_weight_questions) > 1 else highest_weight_questions[0]
